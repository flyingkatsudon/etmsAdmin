...
public class ChartController {
    ...
    public ResponseEntity<ChartJsDto> dept(StatusDto statusDto, JqgridPager pager) {
    ...
    public ResponseEntity<ChartJsDto> hall(StatusDto statusDto, JqgridPager pager) {
