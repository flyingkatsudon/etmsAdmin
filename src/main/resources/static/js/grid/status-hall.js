    ...
    return GridBase.extend({
        initialize: function (options) {
            ...
            var colModel = [
                ...
                {name: 'examineeCnt', hidden: true, label: '배정인원', formatter: 'integer', formatoptions: {thousandsSeparator: ','}},
                ...
                {name: 'toOtherCnt', hidden: true, label: '전출', formatter: 'integer', formatoptions: {thousandsSeparator: ','}},
                {name: 'fromOtherCnt', hidden: true, label: '전입', formatter: 'integer', formatoptions: {thousandsSeparator: ','}},
