        ...
        add: function () {
            ...
            var dialog = new BootstrapDialog({
                ...
                onshown: function (dialog) {
                        ...
                        var dialog = new BootstrapDialog({
                            ...
                            onshown: function () {
                                ...
                                $('#staff').append(
                                    ...
                                    '<input id="first" size="2" type="text" style="border-radius: 10px; padding: 1%; margin-left: 20%">&nbsp;-&nbsp;' +
                                    '<input id="middle" size="2" type="text" style="border-radius: 10px; padding: 1%">&nbsp;-&nbsp;' +
                                    '<input id="last" size="2" type="text" style="border-radius: 10px; padding: 1%">' +
                                    '</div>' +
                    ...
                    // 엑셀 파일로 업로드, 시험 리스트에 기술요원 이름과 전화번호만 입력하면 되므로 systemcontroller에서 엑셀을 내려받음
                    $('#addForm').click(function () {
                        var html = '<form id="uploadStaff" action="upload/staff" method="post" enctype="multipart/form-data">' +
                            ...
                            '<a href="system/staff.xlsx" style="width: 10%; padding: 2%" class="btn btn-primary">양식</a>' +
